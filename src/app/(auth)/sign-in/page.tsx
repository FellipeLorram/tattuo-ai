...
export default function Page() {
	return (
		<div className="flex justify-center items-center h-screen p-2">
			<div className="flex flex-col max-w-lg text-center justify-center items-center gap-10 border p-4 md:p-6 rounded-lg shadow-[0_20px_40px_0_rgba(79,70,229,0.10)]">
				<svg
				...
				<p className='text-gray-50 leading-relaxed'>
					Ao continuar você está configurando uma conta Tattuo e concorda com nosso
